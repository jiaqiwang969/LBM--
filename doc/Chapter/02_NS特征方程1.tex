...
$N(q,v,t)$ 或 $f(q,v,t)$ 为相空间里的粒子数或粒子密度。它在相空间中以($\dot{q}$,$\dot{v}$)的速度行走，在没有碰撞的情况下守恒，所以它满足相空间里的连续性方程。
...
% \begin{equation}
%   \boxed{
%     \partial_{t}\left(\rho E\right)  + \frac{1}{J} \frac{\partial}{\partial q^{i}}\left( \frac{J}{2} g_{jk}\Pi^{i j k} \right) + g_{jk} \Gamma_{mn}\Pi^{njk} =0
%   }
%   \label{能量输运1} ~
% \end{equation}
% %
...
\end{equation}
%
%     & \partial_{t} p + \boldsymbol{u} \cdot \nabla p + \gamma p (\nabla \cdot \boldsymbol{u}) =0
