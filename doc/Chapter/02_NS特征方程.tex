...
%   \begin{gathered}
%     \boxed{
%     \partial_{t}\left(\rho e\right) + \frac{1}{J}\frac{\partial J \rho u^i e}{\partial  q^{i}}    =  \sigma^{ij}  \frac{\partial  u_j}{\partial q^{i}} - \frac{1}{J}\frac{\partial}{\partial q^{i}} (J \mathcal{Q}^i) + \Gamma^i_{mn}  g_{ik} ( u^n \sigma^{km}+u^m \sigma^{nk}) -  \Gamma^i_{mn}  g_{ik} \int \iota^m \iota^n  \iota^{k} f  d \bar{v}
%     }
%   \end{gathered}
% \end{equation}
...
% \begin{equation}
%   \begin{gathered}
%     \int \iota^m \iota^n  \iota^{k} f^{(1)}  d \bar{v} = \int \iota^m \iota^n  \iota^{k} [\iota^i\mathcal{E}_i
...
%     ] f^{(0)} d \bar{v} \\
%     = \int \iota^m \iota^n  \iota^{k} [\iota^i\mathcal{E}_i
%     + {\color{blue} \frac{3}{2e} \mathcal{R}_{ijk} \iota^i\iota^i\iota^k}
%     ] f^{(0)} d \bar{v} \\
%   \end{gathered}
% \end{equation}
